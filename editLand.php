<?php
	...
	$sq = "SELECT * FROM buying WHERE id='".$myid."'";
...
<body>
	...
	<div class="modal">
		...
		<input type="number" name="area" value="<?php echo $arr['area']; ?>">in sq.ft.<br>

		<label for="psqft"><b>Rate</b></label><br>
		<input type="number" name="psqft" value="<?php echo $arr['psqft']; ?>">/sq.ft.<br><br>

		<input class="lower-btn" type="submit" value="Update">
